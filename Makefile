...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test test-cuda-build-contract test-laguna-compact-python test-laguna-resident-plan test-session-snapshot-buffers test-laguna-server-contract \
