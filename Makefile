...
cuda-regression: tests/cuda_long_context_smoke tests/test_cuda_laguna_kernels tests/test_cuda_laguna_stream
	...
	env -u DS4_CUDA_MOE_DECODE_GRAPH -u DS4_CUDA_NO_LAGUNA_FATTN_VEC_DECODE ./tests/test_cuda_laguna_kernels --case decode-attention-fattn-vec-swa-ring
	DS4_CUDA_NO_LAGUNA_FATTN_VEC_DECODE=1 ./tests/test_cuda_laguna_kernels --case decode-attention-fattn-vec-swa-ring
...
ds4_cuda.o: ds4_cuda.cu ds4_cuda_laguna_fattn_vec_policy.h ds4_gpu.h ds4_gpu_mgpu.h ds4_laguna_plan.h ds4_laguna_stream.h ds4_runtime.h ds4_iq2_tables_cuda.inc
...
tests/test_engine_mgpu_runtime: tests/test_engine_mgpu_runtime.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_laguna_stream.o ds4_runtime.o ds4_qualification_control.o ds4_plan_io.o ds4_laguna_plan.o tests/ds4_cuda_laguna_kernels_test_hooks.o ds4_layer_pack.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
tests/test_sampling: tests/test_sampling.o ds4_cuda_test_hooks.o ds4_gpu_args.o ds4_kvstore.o rax.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_laguna_stream.o ds4_runtime.o ds4_qualification_control.o ds4_plan_io.o ds4_laguna_plan.o tests/ds4_cuda_laguna_kernels_test_hooks.o ds4_layer_pack.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
tests/ds4_cuda_laguna_stream_test_hooks.o: ds4_cuda.cu ds4_cuda_laguna_fattn_vec_policy.h ds4_gpu.h ds4_gpu_mgpu.h ds4_laguna_plan.h ds4_laguna_stream.h ds4_runtime.h ds4_iq2_tables_cuda.inc
	$(NVCC) $(NVCCFLAGS) -DDS4_TEST_HOOKS -c -o $@ ds4_cuda.cu
...
tests/test_cuda_laguna_fattn_vec_policy: tests/test_cuda_laguna_fattn_vec_policy.c ds4_cuda_laguna_fattn_vec_policy.h
	$(CC) $(CFLAGS) -I. -o $@ $<

test-cuda-laguna-fattn-vec-policy: tests/test_cuda_laguna_fattn_vec_policy
	./tests/test_cuda_laguna_fattn_vec_policy

test-cuda-build-contract: test-cuda-laguna-fattn-vec-policy
	python3 tests/test_cuda_build_contract.py -v
	python3 tests/test_cuda_laguna_fattn_vec_decode_contract.py -v
...
test-laguna-bench-eval-contract:
