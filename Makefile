...
.PHONY: test-qualification-records test-qualification-evidence test-qualification-supervisor test-qualification-process test-qualification-control-records test-qualification-controlled test-laguna-layer-diagnostics
...
test-laguna-compact-python: test-qualification-records test-qualification-evidence test-qualification-supervisor test-qualification-process test-qualification-control-records test-qualification-controlled test-laguna-layer-diagnostics
